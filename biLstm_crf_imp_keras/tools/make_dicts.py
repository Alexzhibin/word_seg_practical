...
if __name__ == '__main__':
    ...
    make_dictionaries("../data/people-2014/train/2014_processed",
                      src_dict_path="../data/people-2014/train/src_dict.json",
                      tgt_dict_path="../data/people-2014/train/tgt_dict.json",
                      filters="\t\n",
                      oov_token="<UNK>",
                      min_freq=1)
