...
if __name__ == '__main__':
    ...
    args.src_dict_path = "../data/people-2014/train/src_dict.json"
    args.tgt_dict_path = "../data/people-2014/train/tgt_dict.json"
    args.seq_len = 150
    args.txt_path = "../data/people-2014/train/2014_processed"
    args.h5_path = "../data/people-2014/train/2014_processed.h5"
